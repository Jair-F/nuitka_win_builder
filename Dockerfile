...
# Fix for 32-bit Dependency Walker
# RUN curl https://www.dependencywalker.com/depends22_x86.zip -o /tmp/depends22_x86.zip && \
#     mkdir -p /opt/wineprefix/drive_c/users/root/AppData/Local/Nuitka/Nuitka/Cache/downloads/depends/x86/ && \
#     unzip -j /tmp/depends22_x86.zip -d /opt/wineprefix/drive_c/users/root/AppData/Local/Nuitka/Nuitka/Cache/downloads/depends/x86/ && \
